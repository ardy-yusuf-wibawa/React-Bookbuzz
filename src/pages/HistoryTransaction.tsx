...
const HistoryTransaction = () => {
    return (
        ...
        <div className="mt-7">
            <div className="mt-7">
                <img src='./dilan,jpg' className='w-16 h-14 inline-block mr-5' alt='dilan' />
            ...
            <div className=" flex gap-7 justify-end items-end mt-6">
                ...
                <button className="w-20 h-10 border bg-red-600 text-center rounded-md hover:bg-slate-500">Reorder</button>
            </div>
        </div>
