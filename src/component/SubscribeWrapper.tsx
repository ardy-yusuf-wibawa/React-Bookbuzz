...
return (
    <div className="max-w-7xl mx-auto px-[100px] py-[100px]" id="subs-w">
        <div className="text-center">
            ...
            <p className="text-[14px] mb-[50px] text-[#929292]">Subscribe to our newsletters now and stay up to date with
                new collections.</p>
        </div>
            ...
            <form className=" max-w-xl">
                <div className="flex border border-teal-500">
                    <input
                        ...
                        type="text" placeholder="Your email address" aria-label="Full name"/>
                    <button
