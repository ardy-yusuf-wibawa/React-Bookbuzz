...
const ProductWidget = (): React.ReactElement => {
  return (
  <div className="container justify-center items-center relative flex flex-wrap lg:grid lg:grid-cols-3 gap-y-4 gap-x-4 mx-auto px-6 font:poppins
  sm:flex sm:flex-wrap sm:justify-center">
      ...
      <div className="border border-black mb-5 md:w-80 sm:flex-wrap sm:grid sm:grid-cols-2 md:flex">
        <img className="mx-auto sm:float-left self-center w[340px] h[135px]" src={Image} alt=""/>
