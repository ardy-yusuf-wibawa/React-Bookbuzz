    ...
    <>
      <section className='relative flex container items-center mx-auto px-4 py-4'>
        ...
        <div className='w-2/4 flex justify-center'>
          <span className='relative font-[inter] font-normal text-[24px] leading-[29px] tracking-[.075em] text-[#131246]'>
            Our Product
          </span>
        </div>
      ...
      {/* Text */}
      <div className='flex justify-center font-[inter] text-[14px] leading-[17px] pb-[43px] text-slate-900/50'>
