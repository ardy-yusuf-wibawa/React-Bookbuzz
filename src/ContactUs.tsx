      ...
      <div className="container px-6 mx-auto max-w-md sm:max-w-xl md:max-w-5xl lg:flex lg:max-w-full">
        ...
        <div className="mt-10 font-sans text-center font-semibold text-md lg:flex lg:flex-1 flex-wrap lg:p-6">
          <div className="lg:m-auto">
            ...
            <p className="mb-7">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsam consequuntur laudantium esse culpa eveniet
              ratione soluta pariatur repudiandae asperiores veniam, nesciunt iure et exercitationem, nisi aliquam?
              Tempore optio dicta reiciendis quas, officiis ducimus accusantium facilis perspiciatis eius officia
              tenetur nihil dolores veritatis necessitatibus repellendus sunt deserunt! Odit vel tempora accusantium.
            </p>
            <h3 className="mb-7 text-xl">AddressT</h3>
