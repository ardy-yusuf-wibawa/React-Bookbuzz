            ...
            <div id="foto-product">
                <div className="flex flex-col max-w-[525px]  items-center gap-[10px]">
                    <div className="border">
                        <img src="./assets/Product 1/10_bf49c3cd-fade-4f88-9caa-725a72b1018a_600x800_crop_center.png"/>
                    </div>
                    <div id="foto-product-carousel">
                        <ul className="flex flex-row gap-[10px]">
                            <li className="border">
                                <img src="./assets/Product 1/11_e272e529-4c81-454b-b9ff-99dcfba814f1_600x800_crop_center.png"/>
                            </li>
                            <li className="border">
                                <img src="./assets/Product 1/11_e272e529-4c81-454b-b9ff-99dcfba814f1_600x800_crop_center.png"/>
                            </li >
            ...
            <div className="flex w-full max-w-[525px] ">
                <div className="flex flex-col w-full">
                    ...
                    <div className="flex w-full flex-col gap-[15px] border-b-2 pb-[20px] min-[100px]:px-3 sm:px-0">
                        <p id="product-title" className="text-[18px]"> 1. This is the large title</p>
                        <p id="product-rating">
                        ...
                        <p id="product-price" className="text-[16px] font-bold"> $20.00 <span id="discount-price" className="font-normal text-[16px]">$25.00</span></p>
                        <p id="product-sku"> SKU:1001</p>
                    </div>
                    {/*!--- deskripsi product --->*/}
                    <div className="py-5 min-[100px]:px-3">
                        <p className="text-opacity-70 text-black">A long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal...</p>
                    </div>
                    {/*!--- detail product --->*/}
                    ...
                    <div className="flex flex-row gap-[15px] sm:h-[55px] mb-5 text-[14px] min-[100px]:justify-center lg:justify-start min-[100px]:flex-wrap">
                        <div className="flex flex-row gap-[15px] items-center justify-center">
                            <p>QTY</p>
                            <form className="border w-[100px] min-[100px]:h-12 flex items-center justify-center h-full"> 1</form>
                        </div>
                    ...
                    <div className="flex flex-col my-6 min-[100px]:items-center lg:items-start">
                        ...
                        <div className="flex flex-row gap-2">
                            ...
                            <button><i className="fa-brands fa-square-whatsapp fa-2xl"></i></button>
                            <button><i className="fa-brands fa-square-facebook fa-2xl"></i></button>
                            <button><i className="fa-brands fa-square-twitter fa-2xl"></i></button>
                        </div>
                    </div>
                    {/*!--- payment method --->*/}
                    <div className="flex flex-col mb-6 min-[100px]:items-center lg:items-start">
                        ...
                        <div className="flex flex-row gap-2">
                            <button><i className="fa-brands fa-cc-paypal fa-2xl"></i></button>
                            <button><i className="fa-brands fa-cc-visa fa-2xl"></i></button>
                            <button><i className="fa-brands fa-cc-mastercard fa-2xl"></i></button>
                            <button><i className="fa-brands fa-bitcoin fa-2xl"></i></button>
                        </div>
                    </div>
                </div>
            </div>
